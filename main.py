...
if os.path.exists(parameter_file):
    print("\n")
    cprint("Parameter file found. ", "red")
    print("\tLoading parameter from: " + parameter_file)
    working_path = parameter_file[0:-14]
else:
    print("\n")
    cprint("Parameter file not found.", "red")
...
if dataset == "mnist":
    ...
    (x_train, y_train, x_test, y_test) = functions.CIFAR_MAKE_DATA("./", sqrt_N0, P, Ptest, noise)
else:
    cprint("Error: dataset not found.", "magenta")
    exit()
